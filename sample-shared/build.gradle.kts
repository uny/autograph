...
kotlin {
    androidLibrary {
        ...
        // The Compose floor, deliberately — not `android-sampleCompileSdk`. Staying on the published
        // key is what makes this module a live check that a *Compose* consumer can build at the floor
        // the README advertises: CI's `build -x :sample-shared:assemble`
