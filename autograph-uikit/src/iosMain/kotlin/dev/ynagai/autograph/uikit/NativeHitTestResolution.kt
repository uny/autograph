 ...
 * [deepestAccessibilityHitPath] documents overlap and z-order failures (#140). Along a `hitTest` chain those questions do not arise: UIKit already resolved them, including
